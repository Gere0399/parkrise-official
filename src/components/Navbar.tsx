...
export const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 py-8"> {/* Increased padding */}
      <div className="max-w-[1400px] mx-auto flex items-center justify-between px-8">
        ...
        <div className="flex items-center px-4 py-2 bg-white/5 backdrop-blur-sm rounded-full w-40"> {/* Increased width */}
          <MapPin className="w-3 h-3 text-white/70 shrink-0" /> {/* Added shrink-0 to prevent icon from shrinking */}
          <input
            type="text"
