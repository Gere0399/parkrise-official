    ...
    <>
      ...
      <div className="mb-[68px]">
        <div className="container ">
          <div className="flex justify-center items-center mt-[156px] px-4">
            <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[40%,40%,20%]  gap-4 bg-[#0A1B2F] mt-[52px] py-11 overflow-hidden">
          <img
        ...
        <div className="container">
          <div className="xl:w-[1164px] w-full mt-[32px] sm:mt-[76px]">
            ...
            <div className="flex flex-row justify-between flex-wrap xl:flex-nowrap items-start mt-[21px] gap-[24px] xl:gap-[185px]">
              ...
              <div className="flex flex-row justify-start items-start flex-wrap lg:flex-nowrap gap-4 md:gap-10">
                <div>
                  ...
                  <p className="font-open-sans font-normal text-[16px] leading-[22px] text-[#0A1B2F] mt-2">
                    We transform hotels into vibrant extended-stay properties
                    that immerse guests in the neighborhood through local
                    designs, curated events, and unique experiences.
                  </p>
                  <p className="font-open-sans font-bold text-[22px] leading-[24px] text-[#0A1B2F] mt-8">
                    OUR UNIQUE VALUE TO <br /> RESIDENTS AND OWNERS
                  </p>
                  <p className="font-open-sans font-normal text-[16px] leading-[22px] text-[#0A1B2F] mt-2">
                    Our Brand and Culture Delivery team creates a space that
                    allows guests to feel like a local. Hotel owners are left
                    with a sought-after destination where everyone wants to
                    live, resulting in higher occupancy, lower expenses,
                    improved margins, and boosted property value.
                  </p>
                </div>
                <div>
                  <p className="font-open-sans font-bold text-[22px] leading-[16px] text-[#0A1B2F] ">
          ...
          <div className="md:lg:ml-[100px]  mt-[32px] md:mt-[73px] w-full md:w-[541px] px-4">
